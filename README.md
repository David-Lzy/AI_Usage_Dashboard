...
3. run the active numbered queue after `Phase 392.1`: active `Phase 392.2` finishes popup featured-card, action-section, surface-role, and aria copy across 14 locales, then queued `Phase 393` through `Phase 395` cover Settings/provider-detail copy and bounded maintenance follow-up

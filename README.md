...
- Chrome Web Store API status observed on 2026-07-17: manifest version
  `0.2.0.1` published at 100%.
- Current local package version: `0.2.0-rc.2`.
- Current local Chrome manifest version: `0.2.0.2`.
- The `0.2.0.2` revision is the next review candidate; it must not be described
  as published until the Chrome Web Store API reports it as published.

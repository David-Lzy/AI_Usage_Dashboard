...
3. run the active numbered queue after the `Phase 393` split: active `Phase 393.1` expands Settings core copy across 14 locales, then queued `Phase 393.2`, `Phase 393.3`, `Phase 394`, and `Phase 395` cover Settings source controls, Provider Detail/source-display copy, and bounded maintenance follow-up

...
3. continue the active numbered queue after `Phase 398`: active `Phase 399` expands typed source-selection and fallback diagnostic presentation toward 14-locale coverage, then queued `Phase 400` covers adapter-error presentation while preserving raw diagnostic evidence

...
3. execute the `Phase 434` through `Phase 440` UI polish follow-up queue: focused Settings carousel depth layout, circular progress ring label/geometry polish, disclosure chevron state animation, Chrome extension error triage, quota-item 14-locale copy, UI QA/doc closeout, and RC18 packaging only after the fixes are verified

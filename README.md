...
1. continue functional provider work first while Codex budget is constrained; after `Phase 208`, the best next slice is a real authenticated Codex or Cursor operator pass if available

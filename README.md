...
- Chrome Web Store API status observed on 2026-07-21: manifest version
  `0.2.0.5` published at 100%.
- Current local package version: `0.2.0-rc.6`.
- Current local Chrome manifest version: `0.2.0.6`.
- Source `0.2.0-rc.6` / manifest `0.2.0.6` is prepared for the next GitHub
  Release and Chrome Web Store review submission.
- The `0.2.0.6` revision must not be described as submitted or published until
  the Chrome Web Store API reports its real state.

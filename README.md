...
3. no numbered phase is currently queued after `Phase 366`; if continuing unattended, review the project again and create a new small TODO slice before changing behavior

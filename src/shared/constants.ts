  ...
  "claude-code": {
    ...
    sources: [
      ...
      },
      {
        ...
        rolloutStage: "deferred",
        connectionMode: "page_session",
        contractKind: "deferred_personal_page",
        priority: 2,
        ...
        contractDetail:
          "Deferred paid-personal contract. The observed free-account route does not currently expose a usable usage page.",
        graduationGateLabel: "Capture a real Pro or Max usage page",
        graduationGateDetail:
          "Graduate this path only after a live Claude Pro or Max settings/usage page is captured instead of an upgrade redirect.",
        note:
          "Deferred after the 2026-04-22 live spike. In the current logged-in free account, claude.ai/settings/usage redirects to claude.ai/upgrade and exposes plan cards rather than a usable usage surface. Revisit only after capturing a real Pro or Max usage page.",
      },
    ],
  },
  gemini: {
...
export const SAMPLE_APP_STATE: AppState = {
  ...
  providerSettings: [
    ...
    },
    {
      ...
      description:
        "Needed for Claude Code Analytics Admin API requests and dashboard verification.",
    },
    {
      id: "gemini",

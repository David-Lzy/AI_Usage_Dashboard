...
> = {
  "zh-TW": buildCopy("zh-TW", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "已提供管理員分析",
      shipped_enterprise_analytics: "已提供企業分析",
      shipped_personal_partial: "已提供部分個人資料",
      shipped_policy_only: "僅政策已提供",
      deferred_personal_page: "個人頁面已暫緩",
      deferred_project_metrics: "專案指標已暫緩",
      deferred_org_console: "組織控制台路徑已暫緩",
    },
  ...
  ja: buildCopy("ja", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "管理者分析を提供中",
      shipped_enterprise_analytics: "エンタープライズ分析を提供中",
      shipped_personal_partial: "個人向けを一部提供中",
      shipped_policy_only: "ポリシーのみ提供中",
      deferred_personal_page: "個人ページは保留中",
      deferred_project_metrics: "プロジェクト指標は保留中",
      deferred_org_console: "組織コンソール経路は保留中",
    },
    credentialPersistence: {
  ...
  ko: buildCopy("ko", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "관리자 분석 제공됨",
      shipped_enterprise_analytics: "엔터프라이즈 분석 제공됨",
      shipped_personal_partial: "개인용 일부 제공됨",
      shipped_policy_only: "정책만 제공됨",
      deferred_personal_page: "개인 페이지 보류됨",
      deferred_project_metrics: "프로젝트 지표 보류됨",
      deferred_org_console: "조직 콘솔 경로 보류됨",
    },
    credentialPersistence: {
  ...
  "es-419": buildCopy("es-419", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "Analíticas de administración disponibles",
      shipped_enterprise_analytics: "Analíticas empresariales disponibles",
      shipped_personal_partial: "Datos personales parcialmente disponibles",
      shipped_policy_only: "Solo política disponible",
      deferred_personal_page: "Página personal aplazada",
      deferred_project_metrics: "Métricas del proyecto aplazadas",
      deferred_org_console: "Ruta de consola de organización aplazada",
    },
    credentialPersistence: {
  ...
  "pt-BR": buildCopy("pt-BR", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "Análises administrativas disponíveis",
      shipped_enterprise_analytics: "Análises empresariais disponíveis",
      shipped_personal_partial: "Dados pessoais parcialmente disponíveis",
      shipped_policy_only: "Somente política disponível",
      deferred_personal_page: "Página pessoal adiada",
      deferred_project_metrics: "Métricas de projeto adiadas",
      deferred_org_console: "Caminho do console da organização adiado",
    },
    credentialPersistence: {
  ...
  fr: buildCopy("fr", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "Analyses d'administration disponibles",
      shipped_enterprise_analytics: "Analyses d'entreprise disponibles",
      shipped_personal_partial: "Données personnelles partiellement disponibles",
      shipped_policy_only: "Politique uniquement disponible",
      deferred_personal_page: "Page personnelle reportée",
      deferred_project_metrics: "Métriques de projet reportées",
      deferred_org_console: "Accès à la console d'organisation reporté",
    },
    credentialPersistence: {
  ...
  de: buildCopy("de", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "Admin-Analysen verfügbar",
      shipped_enterprise_analytics: "Unternehmensanalysen verfügbar",
      shipped_personal_partial: "Persönliche Daten teilweise verfügbar",
      shipped_policy_only: "Nur Richtlinie verfügbar",
      deferred_personal_page: "Persönliche Seite zurückgestellt",
      deferred_project_metrics: "Projektmetriken zurückgestellt",
      deferred_org_console: "Organisationskonsole zurückgestellt",
    },
    credentialPersistence: {
  ...
  it: buildCopy("it", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "Analisi amministrative disponibili",
      shipped_enterprise_analytics: "Analisi aziendali disponibili",
      shipped_personal_partial: "Dati personali parzialmente disponibili",
      shipped_policy_only: "Solo criteri disponibile",
      deferred_personal_page: "Pagina personale rinviata",
      deferred_project_metrics: "Metriche del progetto rinviate",
      deferred_org_console: "Percorso console organizzazione rinviato",
    },
    credentialPersistence: {
  ...
  ru: buildCopy("ru", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "Аналитика администратора доступна",
      shipped_enterprise_analytics: "Корпоративная аналитика доступна",
      shipped_personal_partial: "Личные данные доступны частично",
      shipped_policy_only: "Доступна только политика",
      deferred_personal_page: "Личная страница отложена",
      deferred_project_metrics: "Метрики проекта отложены",
      deferred_org_console: "Путь к консоли организации отложен",
    },
    credentialPersistence: {
  ...
  ar: buildCopy("ar", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "تحليلات المشرف متاحة",
      shipped_enterprise_analytics: "تحليلات المؤسسة متاحة",
      shipped_personal_partial: "البيانات الشخصية متاحة جزئيًا",
      shipped_policy_only: "السياسة متاحة فقط",
      deferred_personal_page: "الصفحة الشخصية مؤجلة",
      deferred_project_metrics: "مقاييس المشروع مؤجلة",
      deferred_org_console: "مسار وحدة تحكم المؤسسة مؤجل",
    },
    credentialPersistence: {
  ...
  hi: buildCopy("hi", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "एडमिन विश्लेषण उपलब्ध",
      shipped_enterprise_analytics: "एंटरप्राइज़ विश्लेषण उपलब्ध",
      shipped_personal_partial: "व्यक्तिगत डेटा आंशिक रूप से उपलब्ध",
      shipped_policy_only: "केवल नीति उपलब्ध",
      deferred_personal_page: "व्यक्तिगत पेज स्थगित",
      deferred_project_metrics: "प्रोजेक्ट मेट्रिक्स स्थगित",
      deferred_org_console: "संगठन कंसोल पथ स्थगित",
    },
    credentialPersistence: {
  ...
  id: buildCopy("id", {
    ...
    sourceContractLabels: {
      shipped_admin_analytics: "Analitik admin tersedia",
      shipped_enterprise_analytics: "Analitik perusahaan tersedia",
      shipped_personal_partial: "Data personal tersedia sebagian",
      shipped_policy_only: "Hanya kebijakan tersedia",
      deferred_personal_page: "Halaman personal ditunda",
      deferred_project_metrics: "Metrik proyek ditunda",
      deferred_org_console: "Jalur konsol organisasi ditunda",
    },
    credentialPersistence: {

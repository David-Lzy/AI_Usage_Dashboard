...
export const EN_RUNTIME_MESSAGES = {
    ...
    "common.theme.toggle_to_system_title": "Switch to system theme",
    "common.theme.toggle_to_time_label": "By time",
    "common.theme.toggle_to_time_title": "Switch to local-time theme",
    ...
    "popup.actions.hide_footer_info": "Hide footer info",
    "popup.actions.show_footer_info": "Show footer info",
    "popup.providers.collapse_card": "Collapse provider card",
    "popup.providers.expand_card": "Expand provider card",
    "popup.providers.previous": "Previous provider",
    "popup.providers.next": "Next provider",
    ...
    "settings.preferences.popup_provider_browsing_mode.collapsible": "Collapsible cards",
    "settings.preferences.popup_provider_browsing_mode.single": "One card at a time",
    "settings.preferences.popup_provider_browsing_mode.scroll": "Continuous scroll",
    ...
    "settings.preferences.theme_mode.time": "By local time",
    "settings.preferences.theme_mode_helper": "Time mode uses the device's local clock: light from 07:00 to 19:00, dark otherwise. Location is not accessed.",
    ...
    "settings.credentials.codex_session_title": "Codex temporary session token",
    "settings.credentials.codex_session_state": "Session only",
    "settings.credentials.codex_session_help": "Advanced recovery only. Paste a bare ChatGPT access token when automatic local session discovery is unavailable.",
    "settings.credentials.codex_session_input": "Temporary access token",
    "settings.credentials.codex_session_placeholder": "Paste only the token value",
    "settings.credentials.codex_session_save": "Use for this browser session",
    "settings.credentials.codex_session_clear": "Clear temporary token",
    "settings.credentials.codex_session_footer": "The token stays in chrome.storage.session, is sent only to chatgpt.com, and is cleared when the browser session or extension lifecycle ends. Do not paste cookies, JSON, refresh tokens, or an Authorization header.",

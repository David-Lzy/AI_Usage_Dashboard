...
> = {
  "zh-TW": {
    ...
    reviewDetailAction: "檢查",
    openDetailAction: "詳情",
    hideProviderAction: "隱藏",
  },
  ja: {
    ...
    reviewDetailAction: "確認",
    openDetailAction: "詳細",
    hideProviderAction: "非表示",
  },
  ko: {
    ...
    reviewDetailAction: "검토",
    openDetailAction: "상세",
    hideProviderAction: "숨기기",
  },
  "es-419": {
    ...
    reviewDetailAction: "Revisar",
    openDetailAction: "Detalles",
    hideProviderAction: "Ocultar",
  },
  "pt-BR": {
  ...
  fr: {
    ...
    reviewDetailAction: "Examiner",
    openDetailAction: "Détails",
    hideProviderAction: "Masquer",
  },
  de: {
    ...
    reviewDetailAction: "Prüfen",
    openDetailAction: "Details",
    hideProviderAction: "Ausblenden",
  },
  it: {
    providerTriageLabel: "Triage provider",
    ...
    reviewDetailAction: "Rivedi",
    openDetailAction: "Dettagli",
    hideProviderAction: "Nascondi",
  },
  ru: {
    ...
    reviewDetailAction: "Проверить",
    openDetailAction: "Подробнее",
    hideProviderAction: "Скрыть",
  },
  ar: {
    ...
    reviewDetailAction: "مراجعة",
    openDetailAction: "التفاصيل",
    hideProviderAction: "إخفاء",
  },
  hi: {
    providerTriageLabel: "Provider triage",
    ...
    reviewDetailAction: "Review",
    openDetailAction: "Details",
    hideProviderAction: "छिपाएं",
  },
  id: {
    providerTriageLabel: "Triage provider",
    ...
    reviewDetailAction: "Tinjau",
    openDetailAction: "Detail",
    hideProviderAction: "Sembunyikan",
  },
};
  ...
  if (i18n.resolvedLocale === "zh-CN") {
    return {
      ...
      featuredCard: {
        ...
        reviewDetailAction: "复查",
        openDetailAction: "详情",
        hideProviderAction: "隐藏",
      },
      setupCoverage: {
        label: "配置覆盖面",

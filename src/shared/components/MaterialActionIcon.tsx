...
export type MaterialActionIconName =
  | "brightness-auto"
  | "clear-day"
  | "dark-mode"
  | "devices"
...
type MaterialActionIconProps = {
  name: MaterialActionIconName;
} & Omit<SVGProps<SVGSVGElement>, "children" | "viewBox">;

export function MaterialActionIcon({
  name,
  ...svgProps
}: MaterialActionIconProps) {
  ...
  return (
    <svg
      aria-hidden="true"
      data-material-action-icon={name}
      focusable="false"

...
- Chrome Web Store API status shows manifest version `0.2.0.5` published at 100%
- source `0.2.0-rc.6` / manifest `0.2.0.6` is prepared for the next review submission

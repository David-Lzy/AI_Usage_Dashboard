...
- source `0.2.0-rc.8` / manifest `0.2.0.8` is prepared for submission
...
- Source `0.2.0-rc.8` / manifest `0.2.0.8` is prepared for the next review
  submission and is not yet described as published.

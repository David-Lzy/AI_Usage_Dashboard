...
• avisos opcionales de cuota/restablecimiento, con umbrales distintos para alertas en la app y del sistema
• resúmenes por período, exportación CSV segura de agregados e informe de diagnóstico sin datos sensibles
• comparación de despliegues Sub2API guardados cuando período, unidad y moneda son comparables
• lectura opcional de cuotas con Codex CLI Companion, vinculado manualmente en el mismo equipo; las estimaciones equivalentes a la API no son cobros ni saldos
...
AI Usage Dashboard facilita la lectura de estos estados y distingue los datos desconocidos o antiguos de valores recientes de la fuente.

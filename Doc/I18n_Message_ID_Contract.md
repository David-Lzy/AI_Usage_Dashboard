...
- runtime locale architecture now covers 14 locales; `zh-CN` has broad reviewed non-English runtime copy, `zh-TW` has a first shell-level runtime pilot, and other non-English locales currently rely on English fallback for deeper runtime copy until a translation-review phase replaces those entries
...
- reviewed runtime pilot locale:
  - `zh-CN`
- first shell-level runtime pilot locale:
  - `zh-TW`

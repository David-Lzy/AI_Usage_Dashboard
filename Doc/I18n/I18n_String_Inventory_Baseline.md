...
1. Settings, provider-detail, and provider-source wrapper structured copy for all 14 runtime locales
2. typed diagnostic presentation follow-up if the Settings/provider-detail slice stays small enough

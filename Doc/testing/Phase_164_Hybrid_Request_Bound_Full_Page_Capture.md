...
- refreshed the current pending request package so it now includes:
  - [capture-plan.json](../testing/store_screenshot_capture_requests/2026-04-24-surface-expansion-store-screenshot-refresh-request/capture-plan.json)
...
- [04-settings-and-setup-depth.png](../testing/store_screenshot_capture_requests/2026-04-24-surface-expansion-store-screenshot-refresh-request/captures/04-settings-and-setup-depth.png)
- [05-provider-or-dashboard-depth.png](../testing/store_screenshot_capture_requests/2026-04-24-surface-expansion-store-screenshot-refresh-request/captures/05-provider-or-dashboard-depth.png)

...
Current post-`Phase 286` execution priority:

1. `P0` - use `0.1.0-rc.5` as the next install/review package; it includes the Phase 285 post-rc4 smoke polish for provider cards, Settings navigation density, full-page Settings back-to-top positioning, and direct host-access refresh prompts.

...
5. `P1` - no numbered phase is currently queued after `Phase 405`; the next planning slice should choose between localized operator/store visual QA, a release-gate pass, or a maintenance hotspot from `Phase 394`.

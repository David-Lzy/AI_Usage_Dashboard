...
Current post-`Phase 398` execution priority:
...
5. `P1` - continue the numbered queue after `Phase 398`: active `Phase 399` expands typed source-selection and fallback diagnostic presentation toward 14-locale coverage; `Phase 400` covers adapter-error presentation while preserving raw diagnostic evidence.

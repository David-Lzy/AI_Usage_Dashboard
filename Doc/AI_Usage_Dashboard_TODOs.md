...
Current post-`Phase 406` execution priority:
...
5. `P1` - continue the numbered queue after `Phase 406`: active `Phase 407` covers localized operator/store RDP visual QA, then queued `Phase 408` audits localization bundle growth, `Phase 409` scopes interaction-audit consumer-copy presentation, and `Phase 410` scopes store-helper error presentation.

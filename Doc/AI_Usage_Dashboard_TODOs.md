...
Current post-`Phase 469` execution priority:
...
2. `P0` - treat `release/ai-usage-dashboard-0.1.0-rc.21.zip` as the current packaged follow-up candidate. It includes the previous `rc.20` follow-up work plus `Phase 468` Settings tooltip and form-control polish, and no numbered phase is currently queued after `Phase 469`.
...
- treat `rc.13` as the current submitted store-review boundary, and `rc.21` as the current packaged follow-up candidate; `rc.20`, `rc.19`, `rc.18`, `rc.17`, `rc.16`, `rc.15`, `rc.14`, `rc.12`, and `rc.11` remain historical evidence

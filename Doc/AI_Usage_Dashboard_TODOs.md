...
5. `P1` - execute the new `Phase 422` through `Phase 432` UI preference queue: independent provider order per popup/sidebar/full-page surface, per-surface quota item visibility and order, improved progress ring styles, Settings provider carousel migration, and final visual/doc closeout.

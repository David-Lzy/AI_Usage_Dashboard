...
- the immediate next executable work is now the sidebar expand CTA to the route-preserving full-page shell inside the Direction 10 surface-expansion plus ambient-theme line captured in `Doc/Roadmap/10_2_Surface_Expansion_And_Ambient_Theme_Controls_TODOs.md`

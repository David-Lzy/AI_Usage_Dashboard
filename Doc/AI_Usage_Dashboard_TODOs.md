...
Current post-`Phase 439` execution priority:
...
5. `P1` - execute `Phase 440` RC18 packaging only from the verified post-RC17 UI polish source; do not package if a new product-visible regression is found.
...
- `Phase 440` is now active for RC18 packaging from the verified UI polish source

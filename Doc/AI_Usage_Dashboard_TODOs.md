...
- the immediate next repo-owned engineering work is now source-state classification typed-diagnostic fallback under `Doc/Roadmap/09_3_Adapter_Diagnostic_Reason_Code_TODOs.md`

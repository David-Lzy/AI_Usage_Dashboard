...
- the immediate next executable work is now fulfilling and archiving that refreshed screenshot request under `Doc/Roadmap/10_3_Store_Asset_Pack_And_Submission_TODOs.md`, with popup slots still treated as manual native-toolbar capture

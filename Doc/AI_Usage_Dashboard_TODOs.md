...
- the immediate next repo-owned engineering work is now diagnostic archive and export compatibility review under `Doc/Roadmap/09_3_Adapter_Diagnostic_Reason_Code_TODOs.md`

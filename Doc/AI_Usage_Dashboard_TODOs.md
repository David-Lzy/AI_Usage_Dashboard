...
Current post-`Phase 428` execution priority:
...
5. `P1` - continue the `Phase 429` through `Phase 432` UI preference queue: expose the new progress style choices in Settings preview/copy, migrate Settings provider sections into the carousel, and finish visual/doc closeout.

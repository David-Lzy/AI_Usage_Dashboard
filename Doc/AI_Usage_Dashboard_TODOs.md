...
Current post-`Phase 432` execution priority:
...
5. `P1` - no numbered phase is currently queued after `Phase 432`; if the post-`rc.16` display-preference and Settings-carousel source changes should ship, create a separate release/package phase instead of mutating RC13 or RC16 history.

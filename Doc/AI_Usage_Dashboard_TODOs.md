...
Current post-`Phase 504` execution priority:
...
2. `P0` - treat `release/ai-usage-dashboard-0.1.0-rc.23.zip` as the latest packaged follow-up candidate. Current source is ahead of that package through `Phase 504`, which moves provider runtime identity to source-level entries and fixes long-lived-profile legacy-provider migration, and has not been packaged yet.
...
- treat `rc.13` as the current submitted store-review boundary, and `rc.23` as the latest packaged follow-up candidate through the Phase 502 package boundary; current source is ahead through `Phase 504` and has not been packaged, while `rc.22`, `rc.21`, `rc.20`, `rc.19`, `rc.18`, `rc.17`, `rc.16`, `rc.15`, `rc.14`, `rc.12`, and `rc.11` remain historical evidence
...
- `Phase 504` fixed the long-lived Chrome profile migration path so legacy brand-level provider ids are not appended back as runtime extras after source-level normalization; no post-Phase-504 package has been cut yet

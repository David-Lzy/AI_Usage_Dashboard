...
Current post-`Phase 393` execution priority:
...
5. `P1` - continue the localization and maintenance queue after the `Phase 393` split: active `Phase 393.1` expands Settings core runtime copy; `Phase 393.2` expands Settings credential/source/permission helper copy; `Phase 393.3` expands Provider Detail and provider-source display wrapper copy; `Phase 394` audits maintenance hotspots; `Phase 395` splits runtime message catalog modules without changing behavior.

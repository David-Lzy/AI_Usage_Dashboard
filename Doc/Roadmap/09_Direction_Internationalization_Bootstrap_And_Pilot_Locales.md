...
- the deeper runtime copy backlog now maps remaining fallback buckets to Settings/provider-detail helpers in `Phase 393`, then later diagnostics/operator/store-helper follow-up:

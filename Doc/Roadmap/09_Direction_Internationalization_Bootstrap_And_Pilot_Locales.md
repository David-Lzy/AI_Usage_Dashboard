...
- the diagnostic presentation inventory now maps typed warning, source-selection/fallback, and adapter-error presentation copy to `Phase 398` through `Phase 400`, while preserving raw diagnostic evidence outside localization:

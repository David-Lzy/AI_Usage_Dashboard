...
- numbered phase docs are archived through `Phase 398`, with active `Phase 399` selected for typed source-selection and fallback diagnostic presentation 14-locale copy

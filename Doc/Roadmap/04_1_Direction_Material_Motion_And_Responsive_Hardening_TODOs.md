...
- `Phase 245` completed the next post-Phase 236 maintenance split on `2026-05-03` by moving popup-only CSS into `src/popup/popup-theme.css`
- `Phase 246` completed the next post-Phase 236 maintenance split on `2026-05-03` by moving Settings navigation CSS into `src/sidepanel/theme/settings-navigation.css`
...
- current shipped baseline:
  ...
  - popup-only CSS now has a focused popup entry module in `src/popup/popup-theme.css`
  - Settings navigation CSS now has a focused sidepanel-only module in `src/sidepanel/theme/settings-navigation.css`

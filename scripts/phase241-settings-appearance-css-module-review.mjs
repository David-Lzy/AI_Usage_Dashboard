...
async function verifyDocsMarkers() {
  const expectations = [
    {
      relativePath:
        "Doc/testing/Archive/phase-reports/200-299/Phase_241_Settings_Appearance_CSS_Module_Split.md",
      markers: [
        "Phase 241",
    ...
    {
      relativePath:
        "Doc/TODOs/Archive/by-phase/200-299/241_Phase_Settings_Appearance_CSS_Module_Split.md",
      markers: [
        "Phase 241",

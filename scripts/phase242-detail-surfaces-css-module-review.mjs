...
async function verifyDocsMarkers() {
  const expectations = [
    {
      relativePath: "Doc/testing/Archive/phase-reports/200-299/Phase_242_Detail_Surfaces_CSS_Module_Split.md",
      markers: [
        "Phase 242",
    ...
    {
      relativePath:
        "Doc/TODOs/Archive/by-phase/200-299/242_Phase_Detail_Surfaces_CSS_Module_Split.md",
      markers: [
        "Phase 242",

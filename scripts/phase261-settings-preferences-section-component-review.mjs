...
async function verifyDocsMarkers() {
  const expectations = [
    {
      relativePath:
        "Doc/testing/Phase_261_Settings_Preferences_Section_Component_Extraction.md",
      markers: [
        "Phase 261",
    ...
    {
      relativePath:
        "Doc/TODOs/Archive/261_Phase_Settings_Preferences_Section_Component_Extraction.md",
      markers: [
        "Phase 261",

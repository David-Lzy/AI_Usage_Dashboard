...
async function verifyDocsMarkers() {
  const expectations = [
    {
      relativePath:
        "Doc/testing/Archive/phase-reports/200-299/Phase_265_Standard_App_Actions_Split.md",
      markers: [
        "Phase 265",
    ...
    {
      relativePath:
        "Doc/TODOs/Archive/by-phase/200-299/265_Phase_Standard_App_Actions_Split.md",
      markers: [
        "Phase 265",

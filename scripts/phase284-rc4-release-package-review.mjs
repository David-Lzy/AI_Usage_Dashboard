...
const expectedPackageVersion = "0.1.0-rc.4";
const expectedManifestVersion = "0.1.0.4";
const archiveRelativePath =
  "release/ai-usage-dashboard-0.1.0-rc.4.zip";
const artifactDir = path.join(projectRoot, "tmp", "phase284-rc4-release-package-review");
...
async function verifyPackageScript() {
  ...
  assert(
    packageJson.scripts["phase284:review"] ===
      "./scripts/with-preferred-node.sh node ./scripts/phase284-rc4-release-package-review.mjs",
    "package.json is missing the expected phase284:review script.",
  );
  ...
  const expectations = [
    {
      ...
      markers: [
        ...
        archiveRelativePath,
        "Phase 283 RDP Chrome real-device validation has passed",
      ],
    },
    {
      ...
      markers: [
        ...
        expectedManifestVersion,
        archiveRelativePath,
        "Phase 283 RDP Chrome validation",
      ],
    },
    {
    ...
    },
    {
      ...
      markers: [
        "Phase 284",
        expectedPackageVersion,
        "RDP Chrome real-device validation",
    ...
    },
    {
      ...
      markers: [
        "284_Phase_RC4_Release_Packaging.md",
        "latest completed slice",
      ],
    },
    {
      relativePath: "Doc/TODOs/Archive/by-phase/200-299/284_Phase_RC4_Release_Packaging.md",
      markers: [
        "Phase 284",
        expectedPackageVersion,
        archiveRelativePath,
    ...
    {
      relativePath: "Doc/testing/Archive/phase-reports/200-299/Phase_284_RC4_Release_Packaging.md",
      markers: [
        "Phase 284",
        expectedPackageVersion,
        archiveRelativePath,
...
async function runReview() {
  ...
  const reportPath = path.join(artifactDir, "rc4-release-package-review.json");

  await writeFile(reportPath, JSON.stringify(report, null, 2), "utf8");

  console.log("Phase 284 RC4 release package review passed.");

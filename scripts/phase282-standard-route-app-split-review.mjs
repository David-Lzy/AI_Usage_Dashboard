...
async function verifyDocsMarkers() {
  const expectations = [
    {
      relativePath: "Doc/testing/Archive/phase-reports/200-299/Phase_282_Standard_Route_App_Split.md",
      markers: [
        "Phase 282",
    ...
    {
      relativePath:
        "Doc/TODOs/Archive/by-phase/200-299/282_Phase_Standard_Route_App_Split.md",
      markers: [
        "Phase 282",

...
async function verifyDocsMarkers() {
  const expectations = [
    {
      relativePath:
        "Doc/testing/Archive/phase-reports/200-299/Phase_268_Store_Workflow_Copy_Split.md",
      markers: [
        "Phase 268",
    ...
    {
      relativePath:
        "Doc/TODOs/Archive/by-phase/200-299/268_Phase_Store_Workflow_Copy_Split.md",
      markers: [
        "Phase 268",
